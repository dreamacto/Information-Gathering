...
| W5 | 三 skill 硬约束改造 | 已落地 | .claude/skills/{wz,xcx,fh}/SKILL.md 顶部硬约束块 + fh 批次复核门 | wz/xcx 插 6 条硬约束+阶段门声明；fh 插硬约束+第3步改批次复核(verdicts/<order>.json, 游标=已完成批次)，W6 聚合器未建前用连续 range 续作 |
